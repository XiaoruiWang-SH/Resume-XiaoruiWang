            ...
            <div className='content'>
                <div className="header">
                    <div className="header-text">
                        ...
                        <div className="header-row">
                            <div> iOS Software Engineer</div>
                            <div className="mx-2">|</div>
                            <div>Mobile developer & Frontend & Full-Stack</div>
                        </div>
                        <div className="header-row">
                ...
                <div className="body">
                    ...
                    <div className="body-education">
                        ...
                        <div className="body-content">
                            <div>
                                ...
                                <ul className='list-disc list ml-[2ch]'>
                                    <li>A clean, minimalist task management calendar web/H5 application deployed at <a className="text-blue-700 hover:underline hover:text-purple-700" href="https://todocalendar.live">https://todocalendar.live</a>. Features real-time updates, OAuth2 authentication and JWT-based security.</li>
                                    <li>Built with TypeScript/React/Redux/Tailwind CSS/responsive design frontend for mobile and desktop, and Java/Spring Boot/MySQL/RESTful api backend, Deployed with Docker and Nginx reverse proxy at cloud server. </li>
                                </ul>
                            </div>                            
                            <div className="mt-2">
                                <div className='font-bold text-[15px]'>
                    ...
                    <div className="body-education">
                        ...
                        <div className="body-content">
                            <div>
                                <div><span className="font-bold">Programming Languages:</span> JavaScript/TypeScript, Objective-C, Swift, Java, C/C++, Python</div>
                                <div className='mt-1'><span className="font-bold">Frontend:</span> React.js, Tailwind CSS, React Native, Flutter</div>
