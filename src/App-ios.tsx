            ...
            <div className='content'>
                <div className="header">
                    <div className="header-text">
                        ...
                        <div className="header-row">
                            ...
                            <div>Mobile developer & Frontend & Backend & Full-Stack</div>
                        </div>
                        <div className="header-row">
                ...
                <div className="body">
                    ...
                    <div className="body-education">
                        ...
                        <div className="body-content">
                            <div>
                                <div><span className="font-bold">Programming Languages:</span> Objective-C, Swift, C/C++, JavaScript/TypeScript, Java, Python</div>
